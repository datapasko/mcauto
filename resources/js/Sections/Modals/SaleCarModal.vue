...
<template>
    <div v-if="open" class="starting:open:opacity-0"> 
        <div class="fixed inset-0 flex items-center justify-center bg-gray-500/75 z-50 transition-opacity">
            <div class="bg-gray-50 rounded-lg shadow-lg w-lg p-2">
                ...
                <div class="p-2">                    
                    ...
                    <h2 class="text-sm font-semibold text-gray-700 mb-4">Cotización sin compromiso, Tu proximo coche:  {{ car.brand }} - {{ car.model }}</h2>
