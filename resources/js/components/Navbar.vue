...
<template>
  <nav
    :class="[
      ...
      isScrolled ? 'bg-neutral-100 text-gray-800 py-1 shadow-md' : 'bg-white/20 backdrop-blur-md py-3 text-white'
    ]"
  >
...
<!-- 
    ...
    <!-- Button Group -->
    <div class="flex items-center gap-x-1 lg:gap-x-2 ms-auto py-1 lg:ps-6 lg:order-3 lg:col-span-3">
      <a type="button" href="https://wa.me/625742816" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium text-nowrap rounded-xl bg-green-500  text-black hover:bg-green-800 focus:outline-none focus:bg-green-800 ">
        <svg fill="#000000" height="800px" width="800px" version="1.1" id="Icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
            viewBox="0 0 24 24" enable-background="new 0 0 24 24" xml:space="preserve" class="size-4 md:size-5 fill-white">
          <g id="WA_Logo">
            <g>
      ...
      <a type="button" href="https://wa.me/625742816" target="_blank" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium text-nowrap rounded-xl bg-white border border-gray-200 text-black hover:bg-gray-100 focus:outline-none focus:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:hover:bg-white/10 dark:text-white dark:hover:text-white dark:focus:text-white">
        <svg width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="size-4 md:size-5">
