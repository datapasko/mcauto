<template>
    <div class=" bg-primary-800 ">
        <!-- Grid -->
        <div class="flexBetween gap-5 mt-auto w-full max-container py-2">
            <div>
                    <p class="text-gray-200 text-xs text-bold">
                        © {{  year  }} McAuto13, Todos los derechos reservados.
                    </p>
            </div>
            <!-- End Col -->
            ...
            <div class="md:text-end space-x-2">
                <a class="size-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-primary-400 hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:text-neutral-400 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700"
                    href="#">
